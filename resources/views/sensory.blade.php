            ...
            <section class="bg-[#151f32]/60 backdrop-blur-md border border-[#233554] rounded-2xl p-8 relative overflow-hidden">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-sm font-bold px-3 py-1.5 rounded-xl shadow-lg shadow-emerald-500/5" 
                              x-text="getSensorOnlineCount() + ' / 4 Online'">- / 4 Online</span>
                    </div>
                </div>
            ...
            return {
                ...
                updateSensorStatus() {
                    if (this.logs && this.logs.length > 0) {
                        ...
                        // Update status keberadaan sensor
